...
The best way to send feedback is to file an issue at https://github.com/hyperknot/gittag/issues.
...
3. The pull request should work for Python 2.7, 3.4, 3.5 and 3.6, and for PyPy. Check
   https://travis-ci.org/hyperknot/gittag/pull_requests
...
To run a subset of tests::
    ...
    $ python -m unittest tests.test_gittag
